...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN_ALL_SORTED, query = "SELECT m FROM Meal m WHERE m.user.id=:userId " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BETWEEN_ALL_SORTED = "Meal.getBetweenHalfOpen";
